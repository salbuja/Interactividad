...
export const HISTORICOS: Historico[] = [
    ...
    },
    {
        ...
        description: 'Uno de los más destacados generales y samuráis en la historia del país del sol naciente, al haber sido una de las piezas principales en la recuperación militar del clan Minamoto en las Guerras Genpei, tras estos conflictos el clan Minamoto se estableció como el clan dominante en el territorio, Yoshitsune murió traicionado en las manos de uno de los hijos de sus aliados.',
        audios: [{
