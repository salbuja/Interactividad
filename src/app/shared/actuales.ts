...
export const ACTUALES: Actual[] = [
    ...
    },
    {
        ...
        description: 'Hija de un padre haitiano y una madre japonesa, Osaka lleva entrenando casi toda su vida. Es reconocida por ser la primera Jugadora asiática en llegar al número 1 de la asociación de tenis femenil WTA, es una 4 veces ganadora del Gran Slam individual y la campeona actual del abierto de Australia.',
        audios: [{
            title: 'Naomi Osaka',
